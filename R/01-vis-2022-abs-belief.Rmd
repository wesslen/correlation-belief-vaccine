...
Let's examine the first regression to estimate the effect on the absolute belief change (`abs_belief_difference`). We'll use the same functional form as model `m`.
